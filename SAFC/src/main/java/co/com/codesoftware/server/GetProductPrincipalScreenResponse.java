...
/**
 * <p>Clase Java para getProductPrincipalScreenResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getProductPrincipalScreenResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getProductPrincipalScreenResponse", propOrder = {
    "pantallaPrincipalFactTable"
})
public class GetProductPrincipalScreenResponse {
