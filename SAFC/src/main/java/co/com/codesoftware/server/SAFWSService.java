 ...
 * 
 */
@WebServiceClient(name = "SAFWSService", targetNamespace = "http://server.codesoftware.com.co/", wsdlLocation = "http://192.168.0.19:7080/WS/server/SAFWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.0.19:7080/WS/server/SAFWS?wsdl");
